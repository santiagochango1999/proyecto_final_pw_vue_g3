...
const buscarVehiculoRes = async (number) => {
    const data = axios
        .get(` http://localhost:8090/API/v1.0/budget/vehiculos/buscarVehiculoReservado/${number}`
...
const retirarVehiculoSinReserva = async (number) => {
    const data = axios
        .get(`http://localhost:8090/API/v1.0/budget/vehiculos/buscarVehiculoSinReserva/${number}`
...
const reportesClienteVehiculo = async (fechaInicio, fechaFin) => {
    const data = axios
        .get(`http://localhost:8090/API/v1.0/budget/reservas/fechasReservas?fechaInicio=${fechaInicio}&fechaFin=${fechaFin}`
