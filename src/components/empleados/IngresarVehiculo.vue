<template>
  <div class="container">
    ...
    <form class="formulario" @submit.prevent="insertar">
      <div class="insertar">
        <p type="Marca: ">
        ...
        <p type="Avalúo: ">
          <input v-model="avaluo" type="number" placeholder="Avalúo" />
        </p>
        <p type="Valor por día: ">
          <input v-model="valorDia" type="text" placeholder="Valor por día" />
        </p>

        <button class="botR" type="submit">Ingresar</button>
      </div>
    </form>
  </div>
</template>
...
<script>
import { insertarVehiculoFachada } from "@/helpers/clienteReserva";
