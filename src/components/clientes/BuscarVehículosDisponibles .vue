...
<script>
import {consultarVehiculosDisponiblesFachada} from '../helper/clientCliente'
export default {
    data() {
        return {
            datos: null
...
.tabla-avis .fila-cabecera { /* Custom class for table header row */
...
.tabla-avis .celda-texto { /* Custom class for cell containing text */
  text-align: left;
  padding-left: 20px;
}

.tabla-avis .boton-accion { /* Custom class for buttons (Actualizar, Eliminar) */
...
.tabla-avis .boton-accion:hover { /* Optional: add hover effect for buttons */
  background-color: #a51b1b; /* Darken red on hover */
}

.tabla-avis tbody tr:hover { /* Optional: add hover effect for table rows */
